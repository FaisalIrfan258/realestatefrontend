      ...
      <div className="pt-24">
              ...
              <div className="lg:col-span-2">
                ...
                <div className="mt-8">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <DetailItem label="Property ID" value={resolvedParams.id.substring(0, 8)} />
        ...
        <section className="py-16 bg-gray-50 dark:bg-gray-900">
          <div className="container mx-auto px-4">
            ...
            <p className="text-center text-muted-foreground mb-6">Explore other properties that might interest you</p>
