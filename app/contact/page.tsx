...
export const metadata: Metadata = {
  ...
  description:
    "Get in touch with Nasir Property Consultant. We are here to help you with all your real estate needs.",
};
  ...
  const faqItems = [
    {
      ...
      answer:
        "We provide real estate services across major metropolitan areas and surrounding suburbs. Our team has extensive knowledge of local markets and can assist you no matter where you're looking to buy, sell, or rent property.",
    },
    {
      question: "How do I schedule a property viewing?",
      answer:
        "You can schedule a property viewing by contacting us through our website, giving us a call, or sending an email. Our team will coordinate with you to find a convenient time for the viewing and provide you with all the necessary details.",
    },
    {
      question: "What documents do I need when buying a property?",
      answer:
        "When buying a property, you'll typically need identification documents, proof of income, bank statements, and documentation of your assets and liabilities. Our team will guide you through the specific requirements based on your situation and the property you're interested in.",
    },
    {
      question: "Do you offer virtual property tours?",
      answer:
        "Yes, we offer virtual property tours for clients who are unable to visit properties in person. Our virtual tours provide a comprehensive view of the property, allowing you to make informed decisions from anywhere in the world.",
    },
  ];
    ...
    <div className="min-h-screen pt-24 dark:bg-gray-900">
      ...
      <section className="relative py-12 md:py-20 bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-3xl md:text-5xl font-bold mb-4 md:mb-6 bg-clip-text text-transparent bg-gradient-to-r from-primary to-primary/60">
            Contact Us
          </h1>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
            <ContactInfoCard
              ...
              title="Our Location"
              content={
                <>Plot no. 149, street 04, sector C, Akhtar colony Karachi.</>
              }
            />
            <ContactInfoCard
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
            <div className="bg-white dark:bg-gray-800 p-6 md:p-8 rounded-xl shadow-lg">
              ...
              <p className="text-muted-foreground mb-6 md:mb-8">
                ...
                soon as possible. We're looking forward to hearing from you!
              </p>
              <ContactForm />
            </div>
            <div className="bg-white dark:bg-gray-800 p-6 md:p-8 rounded-xl shadow-lg">
              ...
              <p className="text-muted-foreground mb-6 md:mb-8">
                We'd love to meet you in person to discuss your real estate
                needs. Our office is conveniently located in the heart of the
                city.
              </p>
      ...
      <section className="py-12 md:py-16 bg-gradient-to-b from-white to-gray-50 dark:from-gray-800 dark:to-gray-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8 md:mb-12">
            <h2 className="text-2xl md:text-4xl font-bold mb-3 bg-clip-text text-transparent bg-gradient-to-r from-primary to-primary/60">
